 ...
 */
final class Version20211021153746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, last_name, first_name, address, birth_date FROM user');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, birth_date VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, last_name, first_name, address, birth_date) SELECT id, email, roles, password, last_name, first_name, address, birth_date FROM __temp__user');
